...
export default function AdvancedPromotionCard({
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row gap-4  lg:gap-8 justify-center lg:items-center">
        <div>
          <Image
            src={imagUrl}
            alt={title}
        ...
        <div className="flex flex-col gap-4 lg:gap-12">
          <h3 className="font-sans text-base font-bold text-gray-700 lg:mb-0.5">
            {title}
          </h3>
