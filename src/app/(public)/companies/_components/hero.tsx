...
const Hero = ({
  ...
  return (
    <div
      className={cn(
        'z-10 grid grid-cols-3 items-center gap-4 overflow-hidden rounded-md bg-dark-primaryDark bg-cover p-4 lg:gap-8 lg:p-8',
        className
      )}
      // style={{
    ...
    >
      ...
      >
        ...
        {desc && <p className="hidden text-base text-dark-nameWhite md:block">{desc}</p>}
