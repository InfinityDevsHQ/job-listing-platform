...
export default function JobPostSuccess() {
  return (
    <section className="success relative mx-auto my-4 flex max-w-screen-2xl items-center justify-center rounded-md border border-gray-200 bg-gray-50 lg:my-8">
      <Image
