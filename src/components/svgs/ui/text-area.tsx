...
const inputVariants = cva(
  'resize-none overflow-hidden p-2 h-10 w-full peer border-2 border-gray-300 rounded-md bg-white text-black placeholder-gray-400 outline-none transition-all duration-300',
  {
    variants: {
      variant: {
        default: '',
