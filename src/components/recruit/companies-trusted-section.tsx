  ...
  return (
    <section className="flex w-full flex-col items-center gap-8">
      ...
      <div className="grid gap-4 lg:grid-cols-4">
        <div className="flex flex-col gap-4 rounded-lg border border-dark-background3 bg-dark-primary p-4 shadow-theme md:basis-1/2 lg:basis-1/6 lg:p-8">
          <Image
          ...
          />
          <p className="text-center italic text-dark-name">
