...
const InfoBadge = ({ heading, desc }: InfoBadgeProps) => {
	return (
		<div className="w-full max-w-max lg:max-w-none flex-shrink-0 flex flex-col items-center justify-center gap-2 lg:gap-4 rounded-md p-2 lg:p-4 border border-gray-200 bg-gray-50">
