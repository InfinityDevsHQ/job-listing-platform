              ...
              <AccordionContent>
                {editProfile ? (
                  ...
                  <>
                    ...
                    innovative projects. Seeking opportunities to excel in UI design and
          ...
          >
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                ...
                Particularly, proficiency in JavaScript and its associated frameworks such as Vue.js
                and React.js is highly sought after. Moreover, your experience with MongoDB
                positions you well in the growing field of database management.The tech industry is
                highly competitive, with many skilled professionals competing for the same roles.
                However, your diverse experience, including remote work for a US-based startup and
                on-site roles in Dubai and Pakistan, gives you a unique global perspective that can
                set you apart.Potential opportunities for career progression could include roles as
                a Senior Software Engineer or Solutions Architect, where your broad technical skills
                and project management abilities would be highly valued. Your experience with UX
                design also opens up the possibility of specializing in that area, as there is a
                growing demand for professionals who can bridge the gap between technical
                development and user-centric design.The trend in the software engineering field is
                leaning towards full-stack development. While your CV shows deep expertise in
                front-end development, expanding your skills in back-end technologies could increase
                your marketability. Additionally, the trend of remote work is likely here to stay,
                meaning your proven ability to deliver in remote roles could be a significant
                advantage.Overall, your skills and experience place you in a strong position within
                the job market. By continuing to adapt and learn, you can stay ahead of the
                competition and seize the most exciting opportunities in the field.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                ...
                quis corporis deleniti rerum accusantium in est iusto officiis dolore non nesciunt,
                odit recusandae impedit autem consectetur accusamus?
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                ...
                Distinctio iste ipsam iure sequi, atque optio aliquam labore quidem neque est, Lorem
                ipsum dolor, sit amet consectetur adipisicing elit. Quas ducimus assumenda in ullam,
                excepturi corrupti unde nostrum magnam provident inventore deserunt temporibus
                pariatur aliquam, esse obcaecati alias possimus architecto libero!
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-6">
              ...
              <AccordionContent>
                ...
                architecto harum est mollitia molestias totam consequuntur repudiandae, rem dolorum
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio odit ea ducimus
                dicta ipsum obcaecati, recusandae nisi aliquam nostrum minus harum totam laborum
                nesciunt quidem vel modi natus hic dignissimos.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </TabsContent>
